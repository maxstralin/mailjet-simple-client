...
{
    public class GetMessagesInformationRequest : RequestBase
    {
        public GetMessagesInformationRequest(IMailjetKeys options, IQueryFilter queryFilter)
        {
            ...
            Path = "v3/REST/messageinformation/" + queryFilter.CreateQueryParamsString();
        }
    }
}
